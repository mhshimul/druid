...
public class OracleMetadataSegmentManagerProvider implements MetadataSegmentManagerProvider
{
  ...
  @Inject
  public OracleMetadataSegmentManagerProvider(
  ...
  public MetadataSegmentManager get()
  {
    this.lifecycle.addHandler(new Lifecycle.Handler()
    {
      ...
      {
        OracleMetadataSegmentManagerProvider.this.connector.createSegmentTable();
      }
    ...
    return new OracleMetadataSegmentManager(this.jsonMapper, this.config, this.storageConfig, this.connector);
  }
}
