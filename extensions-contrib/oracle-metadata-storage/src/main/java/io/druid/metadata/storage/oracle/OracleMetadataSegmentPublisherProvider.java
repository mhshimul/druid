...
public class OracleMetadataSegmentPublisherProvider implements MetadataSegmentPublisherProvider
{
  @JacksonInject
  @NotNull
  ...
  {
    return new OracleMetadataSegmentPublisher(jsonMapper, config, connector);
  }
}
