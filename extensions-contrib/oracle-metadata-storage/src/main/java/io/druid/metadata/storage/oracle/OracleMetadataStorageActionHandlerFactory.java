...
public class OracleMetadataStorageActionHandlerFactory implements MetadataStorageActionHandlerFactory
{
  ...
  @Inject
  public OracleMetadataStorageActionHandlerFactory(
  ...
  {
    return new OracleMetadataStorageActionHandler<>(
        connector,
        jsonMapper,
        payloadTypes,
        entryType,
