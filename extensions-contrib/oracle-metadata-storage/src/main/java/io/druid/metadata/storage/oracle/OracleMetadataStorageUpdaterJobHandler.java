...
public class OracleMetadataStorageUpdaterJobHandler implements MetadataStorageUpdaterJobHandler
{
  private static final Logger log = new Logger(OracleMetadataStorageUpdaterJobHandler.class);
  private final SQLMetadataConnector connector;
  private final IDBI dbi;

  @Inject
  public OracleMetadataStorageUpdaterJobHandler(SQLMetadataConnector connector)
  {
    ...
    dbi.withHandle((HandleCallback<Void>) handle -> {
      ...
      for (final DataSegment segment : segments) {
        ...
        batch.add(new ImmutableMap.Builder<String, Object>()
                      ...
                      .put("version", segment.getVersion()).put("used", "true")
