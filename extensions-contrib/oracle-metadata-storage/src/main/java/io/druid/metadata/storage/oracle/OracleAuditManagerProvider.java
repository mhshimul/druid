...
public class OracleAuditManagerProvider implements AuditManagerProvider
{
  ...
  @Inject
  public OracleAuditManagerProvider(
  ...
  public AuditManager get()
  {
    ...
    return new OracleAuditManager(connector, dbTables, emitter, mapper, config);
  }
}
